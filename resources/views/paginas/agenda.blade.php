...
<body>
    ...
    <p style="color: #aaa; text-align: center; margin: 0;">Faça uma pré-reserva do seu atendimento.</p>
    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('publico.agendar') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="cliente_name" required>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="observacoes" rows="4" placeholder="Conte resumidamente o tamanho da arte e o local do corpo..."></textarea>
            </div>
